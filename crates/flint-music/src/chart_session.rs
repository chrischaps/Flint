...
// The debug-timeline types (ADR 0037) live in `crate::timeline`; re-exported
// here because the player reaches them via `chart_session::` paths.
pub use crate::timeline::{
    BarMark, PulseMark, SeamMark, SeamMarkKind, TempoMark, TimelineFrame, TimelineMap,
    TimelineSection,
};
