...
impl PostProcessPipeline {
    ...
    pub fn new(
        ...
        let volumetric_blur_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("volumetric_blur_shader.wgsl").into(),
            ),
        });
...
mod tests {
    ...
    /// at 112..176, mode scalars (render_mode/mode_mix/mode_time/pad) at
    /// 176..192, mode_params vec4 at 192..208.
    #[test]
    fn composite_uniforms_match_wgsl_layout() {
        assert_eq!(std::mem::size_of::<PostProcessUniforms>(), 208);
